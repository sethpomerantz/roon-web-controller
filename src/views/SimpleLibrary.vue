<template lang="html">
  <div data-name="TouchscreenViewLibrary" class="library_page">
    <SimpleControlsLibraryNav class="nav_controls" />
    <!-- <SimpleControlsOverlays class="overlay_controls" /> -->

    <div v-if="library && library.list" class="content">
      <div class="list_title" v-if="library.list.title">
        <div class="text_bold">{{ library.list.title }} SIMPLE</div>
        <div v-if="library.list.subtitle">
          {{ library.list.subtitle }} SIMPLE
        </div>
      </div>
...
<script>
import SimpleControlsLibraryNav from "@/components/SimpleControlsLibraryNav.vue";
// import SimpleControlsOverlays from "@/components/SimpleControlsOverlays.vue";
...
export default {
  ...
  components: {
    SimpleControlsLibraryNav,
    // SimpleControlsOverlays,
